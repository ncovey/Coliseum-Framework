...
int main()
{

	{
		...
		EGG::vect<uint32> v = EGG::vect<uint32>();
		//printf("%f\n", fsqrt(testVal));

		EGG::vect<uint32> vInts = EGG::vect<uint32>();
		//EGG::vect<uint32>::iter itr;
...

	{
		...
		real64 matrix3[3][3] = { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } };
		...
		mat3 mtx5 = mtx + matrix3;

		mat3 mtx6 = mtx5.getinverse();
	...
	//	result = fpow(3, -7);
	//	result = fpow(1.28347, 25.323489);
	//	result = frsqrt(155);
	//	result = fsqrt(144);
	//	result = fln(345454656565);
	//	result = sizeof(vec3);
	//	result = pow(3, 7);
